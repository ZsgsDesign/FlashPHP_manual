...
新版的flash框架，已经集成了一个非常轻量级的模板引擎，通过120行左右的代码，实现兼容Smarty开发中最常用的语法，是代替Smarty的首选。
...
flash框架的模板自动输出可以让我们不需要使用display语句就可以将模板输出， 对代码本身而言是简化了不少，对开发者而言也更方便了。
...
比如说：
	...
	http://www.FlashPHP.com/bbs/forum-6-1.html

这个网址浏览器的当前访问目录，是:

	http://www.FlashPHP.com/bbs/
...
那么，这张图片就称为“相对路径”，可以认为，通过以下地址就可以访问到这张图片：
	...
	http://www.FlashPHP.com/bbs/images/logo.gif
...
> 有些时候，当一套FlashPHP的程序，从原来的未开启urlrewrite到开启后，产生页面上图片或者css文件错乱的情况，就有可能是因为使用了相对路径；解决的方案是修改成绝对路径，或者重新调整媒体文件的路径。
...
以下都是绝对路径的例子：
	...
	<link rel="stylesheet" href="/css/style.css" type="text/css" media="screen" />
	<img src="/images/logo.gif" alt="" />
	<script type="text/javascript" src="http://www.FlashPHP.com/js/jquery.js"></script>
	<link rel="stylesheet" href="http://www.FlashPHP.com/css/style.css" type="text/css" media="screen" />
	<img src="http://www.FlashPHP.com/images/logo.gif" alt="" />
